# Roofing Force — Monthly focus & targets

The monthly report reads this file and renders the section for the month AFTER the
report month as "Focus & targets — <Month>". Keep the format exactly:

## YYYY-MM
- one client-friendly bullet per focus item

Update it any month by telling Claude (or the Discord bot) what next month's focus is.
